...
import "../../Offre.css";
import OffersList from "./OffreList";
	...
	const fetchData = async () => {
		try {
			const response = await axios.get(
				`http://localhost:3000/offre/getarchivesbyid/${userId}`
			);
			...
			<section id="services" className="section py" data-aos="fade-up">
				<div className="container">
					<div className="section-title ">
						<h2 className="text-black">Historique de Mes Opportunités</h2>
					</div>
