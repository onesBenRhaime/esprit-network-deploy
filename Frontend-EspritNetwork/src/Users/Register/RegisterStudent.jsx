...
import { registerStudent } from "../../Redux/Actions/userActions";
...
const RegisterStudent = ({ location, history }) => {
    ...
    const submitHandler = (e) => {
		...
		dispatch(registerStudent(name, email,adresseC, password, confirmPassword , pic));
	};
        ...
        <>
            <div className="container-form">
                <div className="img w-100">
                    <img src="https://i.postimg.cc/x8V2D5Gq/the-Team-9.png" alt="Team" />
                </div>
